...
export default function Breadcrumbs({ sidebarOpen }: HeaderProps) {
  ...
  return (
    <div className={clsx(
            ...
            sidebarOpen
            ? "pl-[210px]"
            : pathname === "/" || pathname === "/aiops" || pathname === "/talent-acquisition" || pathname === "/human-resources" || pathname === "/document-search/analyze-rfp" || pathname === "/document-search/analyze-sow" || pathname === "/document-search/generate-SOW-&-BAA" || pathname === "/document-search/service-agreement" 
            ? "pl-[24px]"
            : "w-full"
      )}
    >
